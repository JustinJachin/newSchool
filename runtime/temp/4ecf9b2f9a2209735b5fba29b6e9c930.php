<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpstudy_pro\WWW\school\public/../application/index\view\public\404.html";i:1585013627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="page-error">
                        <div class="page-inner">
                            ...
                            <div class="page-search">
                                <div class="mt-3">
                                    <a href="<?php echo url('index/index'); ?>" class="btn btn-success">返回首页</a>
                                </div>
                            </div>
                        </div>
                    </div>
