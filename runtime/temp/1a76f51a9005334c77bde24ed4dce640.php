    ...
    <ul class="side-menu">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo url('index/index'); ?>">首页</a></li>
             <li class="breadcrumb-item"><a href="<?php echo url('academey/index'); ?>">学院列表</a></li>
            <li class="breadcrumb-item active" aria-current="page">学院修改</li>
        </ol>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editPassword"  method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-md-2 col-form-label" for="academey_name">学院名</label>
                                <div class="col-md-8">
                                    <input type="text" id="academey_name" name="academey_name" class="form-control" value="<?php echo $list['academey_name']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                <label class="col-md-2 col-form-label" for="address">学院地址</label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                <label class="col-md-2 col-form-label">学院编号</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" value="<?php echo $list['num']; ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group mb-0 mt-4 row justify-content-end">
                                <div class="col-md-9">
                                    <button type="submit" class="btn btn-info" οnclick="return false;">提交</button>
                                    <a href="<?php echo url('academey/index'); ?>" class="btn btn-primary">返 回</a> 
                                </div>
                            </div>
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/academey/edit1'); ?>",
            data:formData,
            async:true,
            dataType:'json',
