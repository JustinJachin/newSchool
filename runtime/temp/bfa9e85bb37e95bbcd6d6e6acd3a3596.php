                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editPassword"  method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-md-2 col-form-label" for="passwordOld">旧密码</label>
                                <div class="col-md-8">
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/profile/editPassword'); ?>",
            data:formData,
            async:true,
            dataType:'json',
