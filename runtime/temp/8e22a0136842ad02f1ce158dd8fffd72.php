				...
				<div class="card">
					...
					<div class=" col-lg-12" style="margin-top:20px;margin-bottom: -10px;">
						<div class="float-left" style="margin-right: 10px;">
							<a href="<?php echo url('admin/add'); ?>" class="btn btn-primary">导入</a> 
						</div>
						<div class="float-left" style="margin-right: 10px;">
							<a href="<?php echo url('admin/add'); ?>" class="btn btn-primary">导出</a> 
						</div>
							...
							<tbody>
								...
								<tr class="text-center">
									...
									<td>
										...
										<div class="btn-group align-top">
											<a href="<?php echo url('Teacher/detail?id='.$vo['id']); ?>" class="btn btn-sm btn-info m-b-5 m-t-5">查看详情</a>
										</div>
										
										<div class="btn-group align-top">
											<a href="<?php echo url('Teacher/edit?id='.$vo['id']); ?>" class="btn btn-sm btn-primary m-b-5 m-t-5">修改密码</a>
										</div>
										<div class="btn-group align-top">
...
<script>
    ...
    function btn(id,method,action){
    	var url="<?php echo url('Teacher/"+action+"'); ?>";
