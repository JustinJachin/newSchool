...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?php echo url('teacher/index'); ?>">教师页面</a></li>
    <li class="breadcrumb-item active" aria-current="page">老师查看</li>
</ol>
            ...
            <div class="card-body cards">
                <form id="form" class="form-horizontal" method="post" enctype="multipart/form-data"  target="addfile">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-md-2 col-form-label">教师编号</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group mb-0 mt-2 row justify-content-end">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="<?php echo url('teacher/index'); ?>" class="btn btn-outline-info">返 回</a> 
                        </div>
                    </div>
