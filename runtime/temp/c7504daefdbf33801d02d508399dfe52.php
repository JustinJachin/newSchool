                ...
                <div class="card">
                    ...
                    <div class=" col-lg-12" style="margin-top:20px;margin-bottom: -10px;">
                        <div class="float-left" style="margin-right: 10px;">
                            <a href="<?php echo url('Campus/add'); ?>" class="btn btn-primary">添加校区</a> 
                        </div>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <div class="btn-group align-top">
                                            <button class="btn btn-sm btn-primary badge" data-target="#user-form-modal" data-toggle="modal" type="button"><a href="<?php echo url('campus/edit?id='.$vo['id']); ?>" style="color:#fff;text-decoration:none;">修改</a></button> <button class="btn btn-sm btn-primary badge" onclick="btn(<?php echo $vo['id']; ?>,'','delete')" type="button"><i class="fa fa-trash"></i></button>
                                        </div>
                                    </td>
...
<script>
    ...
    function btn(id,method,action){
        var url="<?php echo url('Campus/"+action+"'); ?>";
    ...
    function moreDel(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('Campus/deletes'); ?>",
            data:{check_val},
            dataType:'json',
