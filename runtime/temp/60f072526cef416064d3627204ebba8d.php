    ...
    <div class="col-lg-12 col-xl-8 col-md-12 col-sm-12">
        <div class="card ">
            <div class="card-header">
                <h4>该用户为<?php echo $volist['type']; ?></h4>
            </div>
