...
<script type="text/javascript">
    $("#form").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/academey/add'); ?>",
            data:formData,
            dataType:'json',
