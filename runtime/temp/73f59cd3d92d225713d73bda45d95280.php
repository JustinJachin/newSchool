    ...
    <ul class="side-menu">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo url('index/index'); ?>">首页</a></li>
             <li class="breadcrumb-item"><a href="<?php echo url('major/index'); ?>">班级列表</a></li>
            <li class="breadcrumb-item active" aria-current="page">班级修改</li>
        </ol>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editPassword"  method="post">
                            <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $list['id']; ?>">
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                <label class="col-md-2 col-form-label" for="year">年级</label>
                                <div class="col-md-8">
                                    <input type="text" id="year" name="year" class="form-control" value="<?php echo $list['year']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                <label class="col-md-2 col-form-label" for="major_name">班级名</label>
                                <div class="col-md-8">
                                    <input type="text" id="major_name" name="major_name" class="form-control" value="<?php echo $list['major_name']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                <label class="col-md-2 col-form-label" for="profession_id">所属专业<span style="color:rgb(255,182,193); font-size: 10px;">（必填）</span></label>
                                <div class="col-md-5">
                                    <select class="form-control select2 w-100"  name="profession_id" id="profession_id">
                                    <?php if(is_array($profession) || $profession instanceof \think\Collection || $profession instanceof \think\Paginator): $i = 0; $__LIST__ = $profession;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($list['profession_id'] == $vo['id']): ?>
                                    <option value="<?php echo $vo['id']; ?>" selected="selected"><?php echo $vo['profession_name']; ?></option>
                                    <?php else: ?>
                                    <option value="<?php echo $vo['id']; ?>"><?php echo $vo['profession_name']; ?></option>
                            ...
                            <div class="form-group mb-0 mt-4 row justify-content-end">
                                <div class="col-md-9">
                                    ...
                                    <a href="<?php echo url('major/index'); ?>" class="btn btn-primary">返 回</a> 
                                </div>
                            </div>
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/major/editDB'); ?>",
            data:formData,
            async:true,
            dataType:'json',
