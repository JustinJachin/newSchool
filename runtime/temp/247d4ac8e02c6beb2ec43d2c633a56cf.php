    ...
    <ul class="side-menu">
        ...
        <?php switch(\think\Session::get('admin_type')): case "0": ?>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item"  href="<?php echo url('Announcement/index'); ?>"><span>公告管理</span></a></li>
                ...
                <div class="card">
                    ...
                    <div class=" col-lg-12" style="margin-top:20px;margin-bottom: -10px;">
                        <div class="float-left" style="margin-right: 10px;">
                            <a href="<?php echo url('Announcement/add'); ?>" class="btn btn-primary">添加公告</a> 
                        </div>
                        <?php if(\think\Session::get('uid') == '1'): ?> 
                        ...
                        <table id="example" class="table table-striped table-bordered border-t0 text-nowrap w-100" >
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><?php echo $vo['useradmin']['username']; ?></td>
                                    <td><?php echo $vo['create_time']; ?></td>
                                    <td><?php echo $vo['update_time']; ?></td>
                                    
                                    <td>
                                        <div class="btn-group align-top">
                                            <a href="<?php echo url('Announcement/detail?id='.$vo['id']); ?>" class="btn btn-sm btn-info m-b-5 m-t-5">查看详情</a>
                                        </div>
                                        <?php if(\think\Session::get('uid') == $vo['adminId']): ?>
                                        <div class="btn-group align-top">
                                            <a href="<?php echo url('Announcement/edit?id='.$vo['id']); ?>" class="btn btn-sm btn-primary m-b-5 m-t-5">编辑公告</a>
                                        </div>
                                        <?php endif; if(\think\Session::get('uid') == '1'): ?> 
                                        <div class="btn-group align-top">
                                            <button class="btn btn-sm btn-danger m-b-5 m-t-5 ajax-get" onclick="det(<?php echo $vo['id']; ?>)" data-toggle="modal" data-target="#prompt"><i class="fa fa-trash" ></i></button>
                                        </div>
                                        <?php else: if(\think\Session::get('uid') == $vo['adminId']): ?>
                                            <div class="btn-group align-top">
                                                <button class="btn btn-sm btn-danger m-b-5 m-t-5 ajax-get" onclick="det(<?php echo $vo['id']; ?>)" data-toggle="modal" data-target="#prompt"><i class="fa fa-trash" ></i></button>
                                            </div>
                                            <?php endif; endif; ?>
...
<script>
    ...
    function btn(id,method,action){
        id=localStorage.a;
        var url="<?php echo url('Announcement/"+action+"'); ?>";
    ...
    function moreDel(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('Announcement/deletes'); ?>",
            data:{check_val},
            dataType:'json',
