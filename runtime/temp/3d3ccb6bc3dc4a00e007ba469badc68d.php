                ...
                <div class="card">
                    ...
                    <div class=" col-lg-12" style="margin-top:20px;margin-bottom: -10px;">
                        <div class="float-left" style="margin-right: 10px;">
                            <a href="<?php echo url('profession/add'); ?>" class="btn btn-primary">添加专业</a> 
                        </div>
                        ...
                        <table id="example" class="table table-striped table-bordered border-t0 text-nowrap w-100" >
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $vo['profession_name']; ?></td>
                                    <td><?php echo $vo['academey']['academey_name']; ?></td>
                                    <td><?php echo $vo['create_time']; ?></td>
                                    <td><?php echo $vo['update_time']; ?></td>
                                    
                                    <td>
                                        <div class="btn-group align-top">
                                            <button class="btn btn-sm btn-primary badge" data-target="#user-form-modal" data-toggle="modal" type="button"><a href="<?php echo url('profession/edit?id='.$vo['id']); ?>" style="color:#fff;text-decoration:none;">修改</a></button> 
...
<script>
    ...
    function btn(id,method,action){
        id=localStorage.a;
        var url="<?php echo url('profession/"+action+"'); ?>";
    ...
    function moreDel(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('profession/deletes'); ?>",
            data:{check_val},
            dataType:'json',
