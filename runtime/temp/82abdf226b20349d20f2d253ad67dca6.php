        ...
        <?php switch(\think\Session::get('admin_type')): case "0": ?>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <?php endif; ?>
                    <li><a class="slide-item" href="index2.html"><span>教师管理</span></a></li>
                    <li><a class="slide-item" href="index3.html"><span>学生管理</span></a></li>
                </ul>
            </li>
            <li class="slide">
            ...
            <li class="slide">
                <a class="side-menu__item"  data-toggle="slide" href="#"><i class="side-menu__icon fa fa-cogs"></i><span class="side-menu__label">班级专业</span><i class="angle fa fa-angle-right"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"  href="#"><span>专业管理</span></a></li>
...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">管理员查看</li>
</ol>
            ...
            <div class="card-body cards">
                <form id="form" class="form-horizontal" method="post" enctype="multipart/form-data"  target="addfile">
                	<div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <img src="/../static<?php echo $volist['pic']; ?>" style="width: 30%;">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">管理员编号</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['num']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['username']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['penname']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                         <div class="col-md-1"></div>
                        ...
                        <div class="col-md-2">
                            <select class="form-control select2 w-100"  disabled>
                            <option selected="selected"><?php echo $volist['sex']; ?></option>
                    ...
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">手机号</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['phone']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">邮 箱</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['email']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['create_time']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">最近更新时间</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['update_time']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">上次登录IP</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['loginIP']; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-1"></div>
                        <label class="col-md-2 col-form-label">上次登录时间</label>
                        <div class="col-md-8">
                            <input type="text"  class="form-control" disabled value="<?php echo $volist['login_time']; ?>">
                        </div>
                    </div>
    ...
    <div class="col-lg-12 col-xl-2 col-md-12 col-sm-12"></div>
                ...
                <footer class="main-footer">
                    <div class="text-center">
                        版权所有©台州学院   邮编：318000   浙ICP备05014578号  地址：浙江省台州市市府大道1139号 党（校）办电话（传真）：0576-88661988  邮箱：tzu@tzc.edu.cn 招生电话：0576-88669696, 0576-85137102 
                    </div>
                </footer>
