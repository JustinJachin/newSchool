    ...
    <ul class="side-menu">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo url('index/index'); ?>">首页</a></li>
             <li class="breadcrumb-item"><a href="<?php echo url('campus/index'); ?>">校区列表</a></li>
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editPassword"  method="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="campusname" name="campusname" class="form-control" value="<?php echo $list['campusname']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                            ...
                            <div class="form-group mb-0 mt-4 row justify-content-end">
                                <div class="col-md-9">
                                    ...
                                    <a href="<?php echo url('campus/index'); ?>" class="btn btn-primary">返 回</a> 
                                </div>
                            </div>
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/campus/editDB'); ?>",
            data:formData,
            async:true,
            dataType:'json',
