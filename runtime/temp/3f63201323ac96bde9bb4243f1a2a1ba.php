...
<script type="text/javascript">
    $("#form").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/profession/add'); ?>",
            data:formData,
            dataType:'json',
