                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="editPassword"  method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="profession_name" name="profession_name" class="form-control" value="<?php echo $list['profession_name']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <?php if(is_array($academey) || $academey instanceof \think\Collection || $academey instanceof \think\Paginator): $i = 0; $__LIST__ = $academey;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($list['academey_id'] == $vo['id']): ?>
                            ...
                            <div class="form-group mb-0 mt-4 row justify-content-end">
                                <div class="col-md-9">
                                    ...
                                    <a href="<?php echo url('profession/index'); ?>" class="btn btn-primary">返 回</a> 
                                </div>
                            </div>
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/profession/editDB'); ?>",
            data:formData,
            async:true,
            dataType:'json',
