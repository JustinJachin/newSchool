...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/academey/editDB'); ?>",
            data:formData,
            async:true,
            dataType:'json',
