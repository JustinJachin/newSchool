                        ...
                        <form class="form-horizontal" id="editPassword"  method="POST">
                            ...
                            <div class="form-group mb-0 mt-4 row justify-content-end">
                                <div class="col-md-9">
                                    ...
                                    <a href="<?php echo url('admin/index'); ?>" class="btn btn-primary">返 回</a> 
                                </div>
                            </div>
...
<script type="text/javascript">
    $("#editPassword").submit(function(){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo url('/index/admin/password'); ?>",
            data:formData,
            async:true,
            dataType:'json',
