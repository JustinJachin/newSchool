							...
							<tbody>
								...
								<tr class="text-center">
									...
									<td>
										...
										<div class="btn-group align-top">
											<a href="<?php echo url('Student/detail?id='.$vo['id']); ?>" class="btn btn-sm btn-info m-b-5 m-t-5">查看详情</a>
										</div>
										
										<div class="btn-group align-top">
											<a href="<?php echo url('Student/edit?id='.$vo['id']); ?>" class="btn btn-sm btn-primary m-b-5 m-t-5">修改密码</a>
										</div>
										<div class="btn-group align-top">
...
<script>
    ...
    function btn(id,method,action){
    	var url="<?php echo url('Student/"+action+"'); ?>";
